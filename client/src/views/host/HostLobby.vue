...
const MODES: { id: Mode; title: string; text: string }[] = [
  {
    id: 'jeopardy',
    title: 'Своя игра',
    text: 'Табло тем и цен, кот в мешке, аукцион, финал со ставками. Нужен пакет вопросов.',
  },
  {
    id: 'brainring',
    title: 'Брейн-ринг',
    text: 'Команды, минута на обсуждение, фальстарты. Можно без пакета — читайте вопросы с листа.',
  },
]
